        ...
        <div className="text-white">
            ...
            <section className="container mx-auto px-4 py-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
                    <div className="bg-neutral-800 rounded-2xl overflow-hidden shadow-lg border border-neutral-700">
            ...
            {/* Features Section */}
            <section className="bg-neutral-800/50 py-16">
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto text-center">
                        <div className="flex flex-col items-center gap-3">
                            <ShieldCheck className="w-10 h-10 text-green-400" />
                            <h3 className="text-lg font-bold">Datos seguros</h3>
                            <p className="text-gray-400 text-sm">Tus datos están protegidos con encriptación y autenticación segura.</p>
                        </div>
                        <div className="flex flex-col items-center gap-3">
                            <Package className="w-10 h-10 text-green-400" />
                            <h3 className="text-lg font-bold">9 categorías</h3>
                            <p className="text-gray-400 text-sm">Organiza tus productos en categorías: Frutas, Lácteos, Carnes y más.</p>
                        </div>
                        <div className="flex flex-col items-center gap-3">
                            <Leaf className="w-10 h-10 text-green-400" />
                            <h3 className="text-lg font-bold">Cuida el planeta</h3>
                            <p className="text-gray-400 text-sm">Reduce el desperdicio alimentario y contribuye a un mundo más sostenible.</p>
                        </div>
                    </div>
                </div>
            </section>
