      ...
      <div className="bg-[#D9D9D9] w-full max-w-md rounded-3xl shadow-lg p-8 flex flex-col items-center">
        ...
        <form onSubmit={handleSubmit} className="w-full space-y-6">
          ...
          <div className="space-y-3 pt-4">
            <button type="submit" className="w-full bg-[#00D97E] hover:bg-[#00c270] text-white font-bold py-4 rounded-2xl flex items-center justify-center transition-colors shadow-md">
